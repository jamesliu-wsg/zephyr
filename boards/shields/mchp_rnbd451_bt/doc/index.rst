...
.. figure:: rnbd451-add-on-board.png
   :height: 350px
   :align: center
...
.. figure:: 2080-atmbusadapter-xpro.png
   :height: 300px
   :align: center
...
.. figure:: same54-with-rnbd451.png
   :align: center
...
To configure the startup time for the external 32 KHz crystal oscillator on the 
SAM E54 Xplained Pro, use the following::

   CONFIG_SOC_ATMEL_SAMD5X_XOSC32K_STARTUP=0x05
