...
#ifndef ZEPHYR_MTCH9010
#define ZEPHYR_MTCH9010
...
struct mtch9010_data_t {
	...
	struct mtch9010_result_t last_result;
};

struct mtch9010_config_t {
	...
	enum mtch9010_operating_mode mode;
	...
	enum mtch9010_output_format format;
